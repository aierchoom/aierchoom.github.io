		...
		case '112':
			...
			setTimeout(function()
			{
				print('……我会去找到他的。。',function()
				{
					...
					setTimeout(function(){addMsg("other","绫人",'为了整个超市的人的安全着想，你务必要这么做。',"img/头像/绫人.png");},time+=1000);
...
function TipsFunc2(tip)
{
	...
	case '2':
			print(text,function()
			{
				...
				setTimeout(function(){addMsg("other","艾丽莎",'锵锵锵——~！',"img/头像/艾丽莎.png");},time+=1000);
				...
				setTimeout(function(){GoBottom()},time+=50);
				setTimeout(function(){addTips(1,'我觉得事态没有那么紧张，放轻松点，穆宁。');addTips(2,'为了以防万一，还是准备一点武器吧。');},time+=50);
						...
						print("我已经在努力做了… ",function()
							{
								...
								setTimeout(function(){addMsg("other","绫人",'而且恐怕你不带上他，他能不能在今天内走出超市都是个问题。',"img/头像/绫人.png");},time+=1000);
